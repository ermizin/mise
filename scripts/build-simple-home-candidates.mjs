...
const microNames = new Map([
  ...
  ["Тимьян", "thyme"], ["Шалфей", "sage"], ["Розмарин", "rosemary"], ["Базилик", "basil"],
  ["Лавровый лист", "bay leaf"], ["Хмели-сунели", "khmeli suneli"], ["Кавказские травы", "Caucasian herbs"],
  ["Мускатный орех", "nutmeg"], ["Перец чили", "chilli powder"], ["Ваниль", "vanilla"], ["Специи", "paprika"],
]);
...
const overnightFlavourSteps = new Map(Object.entries({
  ...
  "foodru-oats-chocolate-shell": "Добавьте овсянку, банан, корицу и грецкие орехи; растопите тёмный шоколад и распределите его сверху тонким слоем.",
  "foodru-oats-no-cook": "Добавьте овсянку, размятый банан и какао, перемешайте.",
}));

const flavourRestorations = new Map(Object.entries({
  "new-home-buckwheat-legs": {
    ingredients: [measuredEditorial("bay leaf", "Лавровый лист", 2), measuredEditorial("Caucasian herbs", "Кавказские травы", 6)],
    steps: [
      "Смешайте куриные бёдра с горчицей, паприкой, кавказскими травами, половиной чеснока и солью.",
      "Овощи слегка обжарьте, переложите в форму, добавьте промытую гречку, лавровый лист и 720 мл кипятка.",
      "Разложите бёдра сверху и запекайте под фольгой 50–60 минут при 180°C, до 74°C в центре мяса.",
      "Смешайте йогурт с оставшимся чесноком и разлейте соус по отдельным ёмкостям.",
    ],
  },
  "new-home-cutlets-mash": {
    ingredients: [measuredEditorial("nutmeg", "Мускатный орех", 1), measuredEditorial("basil", "Базилик", 2)],
    steps: [
      "Смешайте фарш, яйцо, сухари, мелко нарезанный лук, базилик, соль и перец; сформуйте 8 котлет.",
      "Обжарьте по 3–4 минуты с каждой стороны, затем доведите под крышкой до 74°C внутри.",
      "Отварите картофель, разомните с молоком, маслом и мускатным орехом.",
      "Смешайте йогурт, горчицу и соевый соус; упакуйте отдельно.",
    ],
  },
  "new-home-simple-buckwheat": {
    ingredients: [micro("Чёрный перец")],
    steps: [
      "Обжарьте лук и чеснок 3 минуты, затем добавьте помидор, томатную пасту и чёрный перец.",
      "Добавьте кусочки курицы и готовьте до лёгкой корочки.",
      "Всыпьте промытую гречку, влейте 560 мл воды и тушите под крышкой до готовности крупы и курицы; добавьте укроп.",
    ],
  },
  "new-sandwich-balyk": {
    ingredients: [micro("Укроп")],
    steps: [
      "Подсушите хлеб; балык нарежьте тонкими ломтиками.",
      "Смешайте творожную намазку с укропом, нанесите на хлеб и добавьте помидоры.",
      "Добавьте балык и 15 г zero-соуса; соберите сэндвич непосредственно перед едой.",
    ],
  },
  ...
  "foodru-oblomov-chicken-legs": {
    ingredients: [
      measuredEditorial("dried onion", "Сушёный лук", 9), measuredEditorial("dried garlic", "Сушёный чеснок", 10),
      measuredEditorial("paprika", "Сладкая паприка", 14), measuredEditorial("chilli powder", "Перец чили", 7),
      measuredEditorial("herbes de Provence", "Прованские травы", 5), measuredEditorial("curry powder", "Карри", 2),
      gram("greens_raw", "Кинза", 30), gram("white_sugar_processed", "Сахар", 15),
    ],
    steps: [
      "Смешайте сушёные лук и чеснок, сладкую паприку, чили, прованские травы, карри, соль и масло; натрите куриные бёдра и маринуйте 3 часа.",
      "Запекайте или жарьте бёдра до румяности и 74°C в центре мяса.",
      "Для соуса смешайте йогурт, майонез, солёные огурцы, сок лайма, шрирачу, сахар и рубленую кинзу.",
      "Разделите курицу на порции, соус упакуйте отдельно.",
    ],
  },
  "foodru-oblomov-beef-veg": {
    ingredients: [measuredEditorial("bay leaf", "Лавровый лист", 3), measuredEditorial("black peppercorns", "Чёрный перец горошком", 3)],
    steps: [
      "Нарежьте говядину и овощи; отмерьте бульон, лавровый лист и чёрный перец горошком.",
      "Обжарьте говядину партиями до румяной корочки, затем добавьте лук, морковь, сладкий перец, чеснок и томатную пасту.",
      "Влейте бульон, добавьте лавровый лист и перец горошком; тушите до мягкости говядины.",
      "Удалите лавровый лист и разделите блюдо на равные порции вместе с соусом.",
    ],
  },
  "foodru-oblomov-chashushuli": {
    ingredients: [
      gram("greens_raw", "Петрушка", 80), gram("greens_raw", "Кинза", 80), gram("hot_sauce_processed", "Аджика", 40),
      measuredEditorial("khmeli suneli", "Хмели-сунели", 16), measuredEditorial("bay leaf", "Лавровый лист", 1.6),
      measuredEditorial("allspice", "Душистый перец", 3.2), gram("white_sugar_processed", "Сахар", 20),
    ],
    steps: [
      "Обжарьте говядину партиями до румяной корочки, добавьте лук и сладкий перец.",
      "Смешайте томатную пасту с аджикой и хмели-сунели; добавьте к мясу вместе с помидорами.",
      "Добавьте сахар, лавровый лист и душистый перец, влейте немного воды и тушите до мягкости говядины.",
      "Снимите с огня, вмешайте чеснок, петрушку и кинзу; удалите лавровый лист и разделите на порции.",
    ],
  },
  "foodru-oblomov-borscht": {
    ingredients: [
      gram("greens_raw", "Укроп", 15), gram("greens_raw", "Петрушка", 20), measuredEditorial("allspice", "Душистый перец", 10),
      measuredEditorial("cloves", "Гвоздика", 7), measuredEditorial("bay leaf", "Лавровый лист", 3), gram("white_sugar_processed", "Сахар", 50),
    ],
    steps: [
      "Сварите говядину в бульоне с лавровым листом, душистым перцем и гвоздикой до мягкости.",
      "Пассеруйте лук, морковь, сельдерей, свёклу и томатную пасту; добавьте сахар и лимонный сок.",
      "Добавьте овощную заправку и капусту в бульон, варите до мягкости капусты.",
      "Верните нарезанную говядину, добавьте чеснок, укроп и петрушку; удалите целые специи и разделите на порции.",
    ],
  },
  "foodru-oblomov-pepper-beef": { ingredients: [measuredEditorial("bay leaf", "Лавровый лист", 2), measuredEditorial("rosemary", "Розмарин", 4), measuredEditorial("thyme", "Тимьян", 30)] },
  "foodru-oblomov-pepper-chicken": { ingredients: [measuredEditorial("bay leaf", "Лавровый лист", 2), measuredEditorial("rosemary", "Розмарин", 4), measuredEditorial("thyme", "Тимьян", 30)] },
  "foodru-oblomov-sandwich": {
    ingredients: [micro("Перец чили"), micro("Соль")],
    steps: [
      "Замаринуйте курицу в соевом соусе с паприкой, чили и солью на 10 минут.",
      "Обжарьте курицу до 74°C в центре и дайте отдохнуть 5 минут.",
      "Разомните авокадо с лаймом, помидором и луком.",
      "Подсушите хлеб и соберите бутерброд перед едой.",
    ],
  },
  "foodru-blogger-chicken-bombs": {
    ingredients: [measuredEditorial("black pepper", "Чёрный перец", 1), measuredEditorial("thyme", "Тимьян", 1), measuredEditorial("dried garlic", "Сушёный чеснок", 0.9)],
    steps: [
      "Приправьте мясо куриного бедра солью, чёрным перцем, тимьяном и сушёным чесноком.",
      "Обжарьте лук и шампиньоны, добавьте сметану и приготовьте густую начинку.",
      "Сформуйте куриные «бомбочки» с грибной начинкой и запекайте до 74°C внутри; отдельно приготовьте рис.",
      "Смешайте томатную пасту с небольшим количеством воды, прогрейте как соус и разделите всё на пять порций.",
    ],
  },
  "foodru-blogger-cottage-waffles": {
    ingredients: [micro("Ваниль")],
    steps: [
      "Пробейте творог, яйца, протеин и ваниль до однородности.",
      "Вмешайте кукурузную муку и мелко нарезанное яблоко.",
      "Выпекайте в разогретой вафельнице до устойчивой золотистой корочки.",
    ],
  },
  "foodru-oats-chocolate-shell": { ingredients: [measuredEditorial("cinnamon", "Корица", 1.5)] },
}));
...
function applyFinalReviewResolution(input) {
  ...
  const flavour = flavourRestorations.get(config.id);
  if (flavour) {
    config.ingredients.push(...structuredClone(flavour.ingredients));
    if (flavour.steps) config.steps = structuredClone(flavour.steps);
  }

  if (config.id === "new-home-stewed-cabbage") {
    config.ingredients = config.ingredients.filter((ingredient) => ingredient.displayNameRu !== "Зелень");
    config.ingredients.push(gram("greens_raw", "Кинза", 15));
    config.steps[2] = "Добавьте картофель, капусту, кетчуп и ещё 150 мл воды; тушите 20–25 минут до мягкости овощей, затем добавьте кинзу.";
  }
  ...
  if (["foodru-oblomov-pepper-beef", "foodru-oblomov-pepper-chicken"].includes(config.id)) {
    ...
    config.steps = beef
      ? [
          "Нарежьте говядину, лук и чеснок; отмерьте муку, масло, перец, лавровый лист, розмарин, тимьян и 250 мл воды на порцию.",
          "Обжарьте говядину партиями до румяной корочки, добавьте лук и чеснок. Влейте воду, добавьте перец, лавровый лист, розмарин и тимьян; тушите под крышкой 45–50 минут до мягкости мяса.",
      ...
      : [
          "Нарежьте курицу, лук и чеснок; отмерьте муку, масло, перец, лавровый лист, розмарин, тимьян и 250 мл воды на порцию.",
          "Обжарьте курицу партиями до румяной корочки, добавьте лук и чеснок. Влейте воду, добавьте перец, лавровый лист, розмарин и тимьян; готовьте под крышкой до 74°C в центре курицы.",
