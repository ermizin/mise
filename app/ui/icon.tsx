...
const iconPaths: Record<IconName, string[]> = {
  ...
  "meal-breakfast": [
    ...
    "m5.3 5.3 1.4 1.4", "m17.3 17.3 1.4 1.4", "m18.7 5.3-1.4 1.4", "m6.7 17.3-1.4 1.4",
  ],
  "meal-snack-one": [
    "M12 7.5c-2.8-2.8-7.5-.8-7.5 3.6 0 4.7 3.1 9.2 7.5 9.2s7.5-4.5 7.5-9.2c0-4.4-4.7-6.4-7.5-3.6z",
    "M12 7.5c-.2-2.8 1.1-4.4 3.8-5", "M12.2 5.5c-1.8-1.7-3.9-1.7-5.4-.8",
  ],
  "meal-lunch": [
    "M4 12.5h16a8 8 0 0 1-16 0z", "M3 12.5h18", "M7 19.5h10",
    "M8.5 8.5c1.2-1.7 2.5-1.7 3.7 0", "M13 8.5c1.1-1.4 2.2-1.4 3.3 0",
  ],
  "meal-snack-two": [
    "M6 8h10v7.5A3.5 3.5 0 0 1 12.5 19h-3A3.5 3.5 0 0 1 6 15.5z",
    "M16 10h1.5a2.5 2.5 0 0 1 0 5H16", "M5 5h12", "M8 3.5v3", "M15 3.5v3",
  ],
  "meal-dinner": [
    "M17.7 15.8A7.5 7.5 0 0 1 8.2 6.3 7.5 7.5 0 1 0 17.7 15.8z",
    "M17.5 4.5h.01", "M20 8h.01",
  ],
