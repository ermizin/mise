...
const ingredientSeeds: IngredientSeed[] = [
  ...
  ["cheese", "Полутвёрдый сыр (обычный)", "dairy", "processed", n(403, 22.87, 33.31, 3.37), 1, ["milk"]],
  ...
  ["parmesan", "Пармезан (обычный)", "dairy", "processed", n(392, 35.75, 25, 3.22), 1, ["milk"]],
...
const microIngredientReasons: Record<string, string> = Object.fromEntries([
  "black pepper", "cayenne pepper", "chili powder", "cinnamon", "cumin", "fennel seeds",
